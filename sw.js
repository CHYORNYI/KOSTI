const CACHE='kosti-v6-final';
const A=['./','./index.html','./styles.css?v=6','./app.js?v=6','./manifest.webmanifest','./assets/wood.jpg','./assets/leather_black.jpg','./assets/leather_red.jpg','./assets/parchment.jpg','./assets/button.jpg'];
